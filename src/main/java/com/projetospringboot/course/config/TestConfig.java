...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception { //tudo o que colocar dentro deste metodo ira ser executado quando a aplicaçcao for executada
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), u1); //data no formato ISO 8601
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), u2); //associaçao entre obj
